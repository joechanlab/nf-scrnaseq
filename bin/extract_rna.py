...
# From https://github.com/scverse/anndata/issues/595
...
parser.add_argument("output_rna_h5", help="Path to the output RNA h5 file.")
...
write_10X_h5(rna, args.output_rna_h5)
atac.write_h5ad(args.output_atac_h5ad)

print(f"RNA data saved to: {args.output_rna_h5}")
