...
parser.add_argument("--percent_top", required = False, type=str, default = "50,100,200,500", help = "Total count threshold.")
parser.add_argument("--total_counts", required = False, type=int, default = 500, help = "Total count threshold.")
parser.add_argument("--n_genes_by_counts", required = False, type=int, default = 400, help = "Number of genes threshold")
parser.add_argument("--log10GenesPerUMI", required = False, type=float, default = 0.8, help = "log10 genes per UMI threshold")
parser.add_argument("--mito_frac", required = False, type=float, default = 0.2, help = "Mitochondrial fraction threshold")
...
sc.pp.calculate_qc_metrics(
    combined_adata, qc_vars=["mt", "ribo", "hb"], inplace=True, log1p=True, percent_top = tuple(map(int, args.percent_top.split(',')))
)
