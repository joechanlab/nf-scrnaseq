...
parser.add_argument('--n_pca_components', type = int, default = 500, help = "Number of PCA components")
parser.add_argument("--n_diffmap_components", type = int, default = 3, help = "The number of diffusion map components")
parser.add_argument("--leiden_res", type = float, default = 1.8, help = "The resolution of Leiden clustering")
args = parser.parse_args()

adata = sc.read_h5ad(args.input_h5ad)

norm_df = pd.DataFrame(adata.X.toarray(), index=adata.obs_names, columns=adata.var_names)
